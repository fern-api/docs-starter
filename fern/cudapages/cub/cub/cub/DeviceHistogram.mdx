...
### HistogramEven <Badge intent="note" minimal>inline</Badge> <Badge intent="note" minimal>static</Badge>
...
<CodeBlock links={{"DeviceHistogram": "/library/api/cub::DeviceHistogram"}}>
...
<ParamField path="num_row_samples" type="OffsetT">
...
<ParamField path="row_stride_bytes" type="size_t">
...
### MultiHistogramEven <Badge intent="note" minimal>inline</Badge> <Badge intent="note" minimal>static</Badge>
...
The number of histogram bins for channel<sub>i</sub> is `num_levels[i] - 1`.
For channel<sub>i</sub>, the range of values for all histogram bins have the same width: `(upper_level[i] - lower_level[i]) / (num_levels[i] - 1)`
...
<ParamField path="d_histogram" type="::cuda::std::array<CounterT *, NUM_ACTIVE_CHANNELS>">
Embed:rst:leading-asterisk 
...
<ParamField path="num_levels" type="::cuda::std::array<int, NUM_ACTIVE_CHANNELS>">
Embed:rst:leading-asterisk 
...
<ParamField path="num_pixels" type="OffsetT">
...
### to_array <Badge intent="note" minimal>inline</Badge> <Badge intent="note" minimal>static</Badge>
...
### HistogramRange <Badge intent="note" minimal>inline</Badge> <Badge intent="note" minimal>static</Badge>
...
<Note>
The number of histogram bins is (`num_levels - 1`)
The value range for bin<sub>i</sub> is `[level[i], level[i+1])`
...
<ParamField path="d_levels" type="const LevelT *">
...
### MultiHistogramRange <Badge intent="note" minimal>inline</Badge> <Badge intent="note" minimal>static</Badge>
