...
| [`_tensorize_by_key`](#nemo_rl-experience-rollouts-_tensorize_by_key) | - |
...
<Anchor id="nemo_rl-experience-rollouts-_tensorize_by_key">

<CodeBlock showLineNumbers={false} wordWrap={true}>

```python
nemo_rl.experience.rollouts._tensorize_by_key(
    message_logs: list,
    key: str
)
```
