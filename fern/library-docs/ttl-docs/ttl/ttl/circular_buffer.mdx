...
| [`make_dataflow_buffer_like`](#ttl-circular_buffer-make_dataflow_buffer_like) | Create a circular buffer with properties derived from a tensor. |
...
<Anchor id="ttl-circular_buffer-make_dataflow_buffer_like">
...
```python
ttl.circular_buffer.make_dataflow_buffer_like(
    tensor: typing.Any,
    shape: typing.Tuple[int, int],
    buffer_factor: int = 2
