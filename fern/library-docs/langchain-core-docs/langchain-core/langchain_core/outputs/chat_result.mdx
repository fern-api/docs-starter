---
layout: overview
slug: langchain-core/langchain_core/outputs/chat_result
title: langchain_core.outputs.chat_result
---
...
| Name | Description |
|------|-------------|
| [`ChatResult`](#langchain_core-outputs-chat_result-ChatResult) | Use to represent the result of a chat model call with a single prompt. |

### API

<Anchor id="langchain_core-outputs-chat_result-ChatResult">

<CodeBlock showLineNumbers={false} wordWrap={true}>

```python
class langchain_core.outputs.chat_result.ChatResult()
```
...
<ParamField path="generations" type="list[ChatGeneration]">
