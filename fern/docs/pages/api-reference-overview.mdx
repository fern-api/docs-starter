...
| **Fern Definition** | Fern's native API specification format with enhanced features | [Fern Definition docs](https://buildwithfern.com/learn/api-definitions/ferndef/overview) |
